...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Jugugufast.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new Jugugufast.InlineObject();
      //expect(instance).to.be.a(Jugugufast.InlineObject);
    });
    ...
    it('should have the property nftid (base name: "nftid")', function() {
      // uncomment below and update the code to test the property nftid
      //var instane = new Jugugufast.InlineObject();
      //expect(instance).to.be();
    });

    it('should have the property codestr (base name: "codestr")', function() {
      // uncomment below and update the code to test the property codestr
      //var instane = new Jugugufast.InlineObject();
      //expect(instance).to.be();
    });
